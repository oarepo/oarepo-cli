...
@click.pass_context
def initialize(ctx, cfg=None, no_site=False, python=None, step=None, steps=False,
               no_input=False, silent=False, verbose=False, **kwargs):
    ...
    initialize_wizard.run_wizard(cfg, single_step=step, no_input=no_input, silent=silent, verbose=verbose)
    return
